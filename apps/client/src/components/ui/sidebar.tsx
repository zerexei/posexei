...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none transition-[margin,opaicty] ease-linear [&>svg]:size-4 [&>svg]:shrink-0",
